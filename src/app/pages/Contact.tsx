...
const ContactForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
      <div className="rounded-xl shadow-lg p-8 md:w-80 text-gray-900 dark:text-gray-100 shadow-input bg-white dark:bg-black">
        <div>
        ...
        <button type="submit" disabled={state.submitting} className="inline-block self-end font-bold rounded-lg bg-cyan-700 dark:text-gray-900 text-gray-100 px-6 py-2 uppercase text-sm">
          Submit
        </button>
      </div>
    </form>
...
export function Contact() {
  return (
    <div className="antialiased dark:bg-gray-900 bg-gray-100 mt-14">
      <div className="flex w-full min-h-screen justify-center items-center">
        <div className="flex flex-col md:flex-row md:space-x-6 md:space-y-0 space-y-6 bg-cyan-700  w-full max-w-4xl p-8 sm:p-12 rounded-xl shadow-lg text-white">
          <div className=" flex  flex-col justify-between">
            <div>
              <h1 className="font-bold text-4xl tracking-wide">Interested in working together?</h1>
  ...
  {"Get in touch and let's build something together."}
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="mailto:erlalitkumar2005@gmail.com">erlalitkumar2005@gmail.com</a>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="text-teal-300 text-xl"
            ...
            <div className="flex space-x-4 text-lg mt-8">
              {/* linkedin */}
              <a href="https://www.linkedin.com/in/lalitkumarjangid/" target="_blank" rel="noopener noreferrer" >
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 15 15"
              ...
              {/* Github  */}
              <a href="http://www.github.com/lalitkumarjangid" target="_blank" rel="noopener noreferrer">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 15 15"
              ...
              {/* Twitter */}
              <a href="https://www.twitter.com/lkjlalitkumar" target="_blank"  rel="noopener noreferrer">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 15 15"
              ...
              {/* Discord      */}
              {/* <a href="https://www.discord.com/channels/1106644523087560766" target="_blank" rel="noopener noreferrer">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 15 15"
