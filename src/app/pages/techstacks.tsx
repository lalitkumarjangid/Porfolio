...
import {
  ...
  CardTitle,
  HoverEffect,
} from "@/components/ui/card-hover-effect"; // Import the exported components
...
const TechStackSection = ({
  ...
  return (
    <div className="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-lg border border-neutral-100 dark:border-neutral-700">
      <h2 className="text-2xl font-bold mb-4 pl-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-500 dark:from-blue-300 dark:to-purple-300">
        {title}
      </h2>
